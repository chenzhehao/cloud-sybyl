package com.czh.cloud.sybyl.outer.util;

import com.czh.cloud.sybyl.outer.entity.request.SwaggerReq;
import com.czh.cloud.sybyl.outer.entity.response.SwaggerRep;
import com.czh.cloud.sybyl.outer.service.ISwaggerServiceClient;
import com.czh.cloud.sybyl.outer.service.impl.SwaggerServiceClient;
...
public class SwaggerServiceUtil {
     ...
     * @return: com.czh.cloud.common.entity.RootResponse<com.czh.cloud.sybyl.outer.entity.response.SwaggerRep>
     */
